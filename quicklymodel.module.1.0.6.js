        ...
        this.origin = {
            hook: function (prop, value, global = unsafeWindow) {
                ...
                if (typeof value !== 'function' && !localContext.type.isClassInstance(value)) {
                    ...
                    localContext.obj.defineProperty(dec, lastProp, descriptor);
                } else {
                    dec[lastProp] = value;
...
class DOMModule extends BaseModule {
    ...
    initIframe() {
        ...
        this.createElement.subscribe((node) => {
            ...
            this.utils.obj.defineProperty(node, 'contentWindow', {
                get: function () {
...
class NetworkModule extends BaseModule {
            ...
            send(body) {
                ...
                if (res === false) {
                    const hook_get = (name, value) => {
                        localContext.utils.obj.defineProperty(this, name, {
                            get: function () {
                                return value;
                            }
                        });
    ...
    initDyncFileLoad() {
        ...
        const hookSrc = (node) => {
            ...
            this.utils.obj.defineProperty(node, property, {
                get: function () {
                    return this.src_;
                },
                set: function (value) {
        ...
        const startAnimation = () => {
            ...
            const animate = (timestamp) => {
                if (timestamp - lastTime >= interval) {
                    decNode.style[decProName] = this.utils.dom.randomColor();
                    lastTime = timestamp;
                }
...
class OtherModule extends BaseModule {
    ...
    initWebpack() {
        ...
        this.utils.obj.defineProperty(unsafeWindow, this.config.webpack, {
            get: function () {
                return webpack;
            },
            set: function (value) {
...
class VideoModule extends BaseModule {
    ...
    initHls() {
        ...
        this.utils.obj.defineProperty(unsafeWindow, 'Hls', {
            get: function () {
                return Hls_;
            },
            set: function (value) {
